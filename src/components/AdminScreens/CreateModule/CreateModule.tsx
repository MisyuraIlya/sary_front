                  ...
                  <form onSubmit={handleSubmit} encType="multipart/form-data" className='justify-end items-end flex gap-12'>
                      ...
                      <>
                        ...
                        <div className='justify-center items-center h-full flex'>
                          <Image src={'/images/eye.svg'} width={25} height={25} alt='eye' className='cursor-pointer flex ' onClick={() =>  window.open(`http://3.74.228.194:4000/${exercises?.xl}`, '_blank', 'noopener')} />
                        </div>
