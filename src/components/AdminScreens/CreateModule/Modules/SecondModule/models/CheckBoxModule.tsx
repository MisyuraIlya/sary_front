...
const CheckBoxModule:FC<CheckBoxModuleProps> = ({checkIsThereImage, values, setValue, exerciseId, dataObjectId, col , row, answer, isTable}) => {
    ...
    return (
        <th 
        style={{width:'100%'}}
        className={`${checkIsThereImage ? '' : 'specific-th'} ${isTable ? 'tableModule' : ''}`}
        >
            <div>
