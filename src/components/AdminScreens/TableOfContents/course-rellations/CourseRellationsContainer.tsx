...
const CourseRellationsContainer: FC<CourseRellationsContainerProps> = () => {
    const {CourseMethods,lvl1,lvl2,lvl3,lvl4,choosedLvl1,choosedLvl2,choosedLvl3,choosedLvl4} = useCourse()
    return (
        <div className='grid grid-cols-4 gap-4 px-12 '>
            {lvl1?.children &&
                ...
                choosedLVl={CourseMethods.setChoosedLvl2} 
                isExercise={false}
                />        
            }
            {lvl2?.children &&
                ...
                choosedLVl={CourseMethods.setChoosedLvl3} 
                isExercise={false}
                />        
            }
            ...
            {lvl3?.children &&
                ...
                choosedLVl={CourseMethods.setChoosedLvl4} 
                isExercise={false}
                />        
            }
            ...
            {lvl4?.children &&
                ...
                choosedLVl={CourseMethods.setChoosedLvl5} 
                isExercise={true}
                />        
            }
        </div>
