...
export type module_type =  "word" | "orden" | "instruction" | "subInstruction" | "text" | "input" | "selectbox" | "textarea" | "rootInput" | "mix" | "bank" | 'mixDrag' | 'checkBox' | 'image' | 'merged' | 'table' | 'questInstruction' | 'openQuestion' | 'mergedExercise' | 'textCopy' | 'headline2' | 'clearText' | 'typedInput' | 'openQuestionHamarot' | 'draftBank' | 'draft' | 'tableClear' | ''
